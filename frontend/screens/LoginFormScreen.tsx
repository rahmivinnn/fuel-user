    ...
    <div className="relative w-full max-w-[402px] mx-auto min-h-screen bg-white">
      ...
      <div className="px-4 pt-6 pb-8">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-4 rounded-full bg-[#3AC36C] hover:bg-[#2ea85a] text-white font-semibold text-base shadow-lg transition-all duration-300 active:scale-95 disabled:opacity-70 mt-6"
            disabled={isLoading}
          >
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full py-4 rounded-full border-2 border-gray-300 bg-white hover:bg-gray-50 text-gray-700 font-semibold text-base flex items-center justify-center gap-3 shadow-md transition-all duration-300 active:scale-95 disabled:opacity-70"
          >
