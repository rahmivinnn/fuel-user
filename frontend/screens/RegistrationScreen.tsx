...
const Step1 = ({ next, formData, handleChange }: StepProps) => {
    ...
    return (
        <div className="space-y-4">
            ...
            <button 
                type="button"
                className="w-full py-4 bg-white border-2 border-gray-300 text-gray-700 hover:bg-gray-50 rounded-full font-semibold text-base flex items-center justify-center gap-3 shadow-md transition-all duration-300 active:scale-95"
            >
