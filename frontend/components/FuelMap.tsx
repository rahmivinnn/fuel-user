...
// Use the provided Mapbox API key directly
const MAPBOX_TOKEN = 'pk.eyJ1IjoidmluYTk4IiwiYSI6ImNtN3I3eDF6ZTB2OW0yam9kdzFxdndhdTkifQ.HNqbNgBUAoBPYmoAMISdaw';
...
const FuelMap: React.FC<FuelMapProps> = ({ stations, userLocation, onStationSelect }) => {
