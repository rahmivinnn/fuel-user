            ...
            <div className="flex justify-center space-x-3">
              {otp.map((digit, index) => (
                <input
                  ...
                  maxLength={1}
                  className="w-12 h-12 text-center text-xl font-bold border-2 border-gray-300 dark:border-gray-600 rounded-lg bg-transparent focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary mobile-text-2xl"
                  disabled={isLoading}
                />
              ))}
            </div>
