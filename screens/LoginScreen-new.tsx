          ...
          {!isWhatsAppLogin && (
            <>
              ...
              <button 
                ...
                className="w-full h-12 border border-green-400 text-gray-700 text-base font-medium rounded-full hover:bg-gray-50 active:scale-[0.98] transition-all duration-150 flex items-center justify-center mb-8"
              >
